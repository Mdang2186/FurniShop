    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <h5 class="brand"><i class="fas fa-couch me-2"></i> LUXE INTERIORS</h5>
      ...
      <!-- Payments & Banks (sửa lỗi icon, có fallback) -->
      <div class="badges">
        <!-- Cổng thanh toán -->
        <img class="logo" src="${path}/assets/images/payments/visa.svg" alt="Visa" onerror="luxeFallback(this,'VISA')">
        ...
        <span class="sep"></span>
        <!-- Ngân hàng nội địa -->
        <img class="logo" src="${path}/assets/images/banks/vietcombank.svg" alt="Vietcombank" onerror="luxeFallback(this,'VCB')">
        <img class="logo" src="${path}/assets/images/banks/techcombank.svg" alt="Techcombank" onerror="luxeFallback(this,'TCB')">
        ...
        <img class="logo" src="${path}/assets/images/banks/mbbank.svg" alt="MB Bank" onerror="luxeFallback(this,'MB')">
      </div>
    </div>
  </div>
