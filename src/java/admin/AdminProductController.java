...
public class AdminProductController extends HttpServlet {
  @Override protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    int total = pdao.countProducts(keyword, (cid==null?null:List.of(cid)), 0, 0);
    List<Product> data = pdao.searchAndFilterProducts(keyword, (cid==null?null:List.of(cid)), 0, 0, "newest", (page-1)*size, size);

    req.setAttribute("products", data);
    req.setAttribute("categories", cdao.getAllCategories());
    req.setAttribute("q", keyword); req.setAttribute("cid", cid);
