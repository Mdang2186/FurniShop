<%-- Thay thế toàn bộ file: includes/header.jsp --%>
    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <header class="sticky-top bg-white shadow-sm">
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand fw-bold fs-4 font-playfair" href="${path}/home">
                        <i class="fas fa-couch" style="color: var(--gold4);"></i> 
                        LUXE INTERIORS
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <form class="d-flex me-3" action="${path}/shop" method="get" role="search">
                            <input class="form-control me-2 rounded-pill" type="search" name="keyword" value="${keywordValue}" placeholder="Tìm sản phẩm..." aria-label="Search">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <c:if test="${empty sessionScope.account}">
                                <a href="${path}/login" class="btn btn-dark">Đăng nhập</a>
                            </c:if>
                        </div>
                    </div>
                </div>
