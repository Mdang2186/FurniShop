...
<table class="table table-luxe">
  <%-- SỬA LỖI: Đã xóa cột "Mô tả" --%>
  <thead><tr><th>ID</th><th>Tên</th><th class="text-end">Thao tác</th></tr></thead>
  <tbody>
    <c:forEach items="${categories}" var="c">
      <%-- SỬA LỖI: Đã xóa <td>${c.description}</td> --%>
      <tr><td>${c.categoryID}</td><td><b>${c.categoryName}</b></td>
        <td class="text-end">
